...
def set_include_in_context():
    ...
    zap.context.exclude_from_context(context_name, '\\Qhttp://localhost:8000/login.php\\E')
    zap.context.exclude_from_context(context_name, '\\Qhttp://localhost:8000/logout.php\\E')
    zap.context.exclude_from_context(context_name, '\\Qhttp://localhost:8000/setup.php\\E')
    zap.context.exclude_from_context(context_name, '\\Qhttp://localhost:8000/security.php\\E')
...
def set_script_based_auth():
    ...
    login_request_data = "scriptName=auth-dvwa.js&Login_URL=http://localhost:8000/login.php&CSRF_Field=user_token" \
...
def upload_script():
    ...
    file_name = 'C:/Users/dnwn7/OWASP ZAP/scripts/scripts/authentication/dvwa.js'
    charset = 'UTF-8'
